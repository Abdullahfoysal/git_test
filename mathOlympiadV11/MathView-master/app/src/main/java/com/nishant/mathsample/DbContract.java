...
public class DbContract {
    ...
    public static final String SERVER_URL="http://192.168.0.105/syncdemo/sync.php";
    public static final String SERVER_URL2="http://192.168.0.117/syncdemo/dataSync.php";//work with
    public static final String SERVER_URL3="http://192.168.0.117/syncdemo/dataFetch.php";//work with
