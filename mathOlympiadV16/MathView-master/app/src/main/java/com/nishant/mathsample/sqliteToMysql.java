...
public class sqliteToMysql extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sqlite_to_mysql);

        recyclerView = this.<RecyclerView>findViewById(R.id.recyclerViewId);
        Name= this.<EditText>findViewById(R.id.nameId);
    ...
    private void saveToAppServer(final String name){
        ...
        if(checkNetworkConnection()){
            ...
            StringRequest stringRequest=new StringRequest(Request.Method.POST, DbContract.PROBLEM_DATA_SYNC_URL,
            ...
            })
            {
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    ;
            MySingleton.getInstance(sqliteToMysql.this).addToRequestQue(stringRequest);


        }
        else{//save to sqlite database
            saveToLocalStorage(name,DbContract.SYNC_STATUS_FAILED);
    ...
    private void saveToLocalStorage(String name,int sync){
        ...
        //save to sqlite database
            long id= dbHelper.saveToLocalDatabase(name,sync,database);
